...
const newTbodyStr = `                       <tr key={v.id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
...
lines.splice(2890, 51, newTbodyStr);
fs.writeFileSync('src/App.jsx', lines.join('\n'));
console.log('done patch vocab tbody');
