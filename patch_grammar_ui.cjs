...
const searchStr = `<span className="ml-1 text-slate-600 font-bold flex items-center flex-wrap gap-1 bg-slate-50 px-2.5 py-1 rounded-lg border border-slate-100 shadow-sm">
                                   {(() => {
...
let lines = c.split('\\n');
// manual replacement because white spaces might be tricky
